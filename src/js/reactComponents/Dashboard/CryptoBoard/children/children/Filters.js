    ...
    return (
      <section className="table-filters col-md-12 col-sm-12 col-xs-12">
        <div className="well dropdown-group">
          <Dropdown 
            onClickHandler={this.props.filterByMarketCap}
          ...
          />
          <Dropdown 
            onClickHandler={this.props.filterByPrice}
          ...
          />
          <Dropdown 
            onClickHandler={this.props.filterByVolume_24h}
        ...
        <div className="well full_width">
            <Dropdown 
            onClickHandler={this.props.changeTableCurrency}
            ...
            <h4>Table Length</h4>
            <ButtonGroup 
                onClickHandler={this.props.changeTableLength}
