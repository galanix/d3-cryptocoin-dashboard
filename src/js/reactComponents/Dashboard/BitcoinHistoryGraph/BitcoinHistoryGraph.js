...
import BtnGroup from '../../General/BtnGroup';
    ...
    <div className='col-lg-6 col-md-12 col-sm-12 col-xs-12'>                        
        <section id='history' className='row x_panel'>
            ...
            <div className='col-md-12 col-sm-12 col-xs-12'>
                ...
                <BtnGroup classesCSS='full-width'
                          buttons={[
                            { attributes: { 'data-timeline': 'all-time' },
                              classesCSS:'btn btn-success',
                              textValue: 'All time'
                            },
                            { attributes: { 'data-timeline': '1-year' },
                              classesCSS: 'btn-success',
                              textValue: 'Year'
                            },
                            { attributes: { 'data-timeline': '6-month' },
                              classesCSS: 'btn-success',
                              textValue: '6 months'
                            },
                            { attributes: { 'data-timeline': '3-month' },
                              classesCSS: 'btn-success',
                              textValue: '3 months'
                            },
                            { attributes: { 'data-timeline': '1-month' },
                              classesCSS: 'btn-success active',
                              textValue: '1 month'
                            },
                            { attributes: { 'data-timeline': '1-week' },
                              classesCSS: 'btn-success',
                              textValue: 'week'
                            },
                          ]}
